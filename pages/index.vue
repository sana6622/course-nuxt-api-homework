    ...
    >
      ...
      >
        ...
        <div class="room-intro-content text-neutral-0">
          ...
          <NuxtLink
            to="/rooms"
            class="btn btn-neutral-0 d-flex justify-content-end align-items-center gap-3 w-100 p-5 p-md-10 mb-6 mb-md-10 text-end text-neutral-100 fs-7 fs-md-5 fw-bold border-0 bt-bgc"
          >
            查看更多
            <div class="cta-deco" />
          </NuxtLink>
